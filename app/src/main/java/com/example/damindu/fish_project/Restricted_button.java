...
//        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.p_2:
                Intent intent_1 = new Intent(Restricted_button.this, Prob_content.class);
                intent_1.putExtra("key", "2");
                startActivityForResult(intent_1, REQUEST_CODE_1);
                break;

            case R.id.p_3:
                Intent intent_2 = new Intent(Restricted_button.this, Prob_content.class);
                intent_2.putExtra("key", "3");
                startActivityForResult(intent_2, REQUEST_CODE_1);
                break;

            case R.id.p_4:
                Intent intent_4 = new Intent(Restricted_button.this, Prob_content.class);
            ...
            case R.id.p_5:
                Intent intent_5 = new Intent(Restricted_button.this, Prob_content.class);
                intent_5.putExtra("key", "5");
                startActivityForResult(intent_5, REQUEST_CODE_1);
                break;

            case R.id.p_6:
                Intent intent_6 = new Intent(Restricted_button.this, Prob_content.class);
                intent_6.putExtra("key", "6");
                startActivityForResult(intent_6, REQUEST_CODE_1);
                break;

            case R.id.p_7:
                Intent intent_7 = new Intent(Restricted_button.this, Prob_content.class);
            ...
            case R.id.p_8:
                Intent intent_8 = new Intent(Restricted_button.this, Prob_content.class);
                intent_8.putExtra("key", "8");
                startActivityForResult(intent_8, REQUEST_CODE_1);
                break;

            case R.id.p_9:
                Intent intent_9 = new Intent(Restricted_button.this, Prob_content.class);
                intent_9.putExtra("key", "9");
                startActivityForResult(intent_9, REQUEST_CODE_1);
                break;

            case R.id.p_10:
                Intent intent_10 = new Intent(Restricted_button.this, Prob_content.class);
            ...
            case R.id.p_11:
                Intent intent_11 = new Intent(Restricted_button.this, Prob_content.class);
                intent_11.putExtra("key", "11");
                startActivityForResult(intent_11, REQUEST_CODE_1);
                break;

            case R.id.p_12:
                Intent intent_12 = new Intent(Restricted_button.this, Prob_content.class);
                intent_12.putExtra("key", "12");
                startActivityForResult(intent_12, REQUEST_CODE_1);
                break;

            case R.id.p_13:
                Intent intent_13 = new Intent(Restricted_button.this, Prob_content.class);
